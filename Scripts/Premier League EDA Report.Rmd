...
```{r ranges of goals boxplots overall, comment = "#", fig.height = 8.5, fig.width = 11, fig.align = "left"}
...
```{r ranges of goals scored boxplots group breakouts, comment = "#", fig.height = 8.5, fig.width = 13, fig.align = "left"}
